...
\relscale{\relscalefact}
  ...
  \begin{defn*}[One-Sided Limits]
    ...
    The function $f$ has a \textbf{left-hand limit} $M$ as $x$ approaches $a$ from the left, written
    \begin{align*}
      \lim_{x\to a^-} f(x)=M
    \end{align*}
    ...
    \begin{tikzpicture}[declare function={
      ...
      \begin{axis}[
        ...
        every axis plot/.append style={line width=0.95pt, color=lander_blue},
          ...
          \addplot[->,samples at={-6,-5.975,...,-2.005,-2,-1.95,...,-1.0015,-1.005,-1,-0.975,...,7.5}] {g(x)};
          \addplot[holdot] coordinates{(-1,0)(2,-2)};
          \addplot[soldot] coordinates{(-1,-2)(2,1)};
      \end{axis}
    \end{tikzpicture}
    % }}
  \end{center}
  ...
  Below are examples where the limit does not exist: \hfill\href{https://www.desmos.com/calculator/fe5vr8ozyd}{\textcolor{blue}{\underline{Graph}}}
...
%          \node[align=left, anchor=south west] at (axis cs: 0.25,0.25) [draw, rectangle, rounded corners, font=\large] {Jump\\ discontinuity};
  ...
  \begin{thmBox*}[Continuity Checklist:]
