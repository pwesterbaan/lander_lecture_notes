...
%          \node[align=left, anchor=south west] at (axis cs: 0.25,0.25) [draw, rectangle, rounded corners, font=\large] {Jump\\ discontinuity};
        \nextgroupplot[xmin=-0.5, xmax=3.5,ymin=-7, ymax=35]
          \addplot[<->] expression[unbounded coords=jump, domain=-0.5:3.5, samples=99] {(x-2.5)^-2};
          \draw[dashed] (axis cs: 2.5,-7) -- (axis cs: 2.5,35);
        \nextgroupplot[xmin=-0.75, xmax=0.75, ymin=-1.25, ymax=1.25]
          \def\n{10}
        ...
        \nextgroupplot[xmin=-6*pi, xmax=6*pi, ymin=-1.25, ymax=1.25]
