...
\relscale{\relscalefact}
  ...
  \begin{thmBox*}[Combining Transformations]
    \begin{itemize}
      \item 
        When combining vertical transformations written in the form $af(x)+k$, first vertically stretch by $a$ and then shift by $k$.
      \item 
        When combining horizontal transformations written in the form $f(bx-h)$, first horizontally shift by $h$ and then horizontally stretch by $\dfrac{1}{b}$.
      \item 
