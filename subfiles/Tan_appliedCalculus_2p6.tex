...
%  \relscale{1.4} %TODO
  ...
  \hfill\smash{\raisebox{-\height}{\href{https://www.desmos.com/calculator/zn9l7ssfc0}{\textcolor{blue}{\underline{Graph}}}}}
  \begin{center}
  ...
  \begin{ex*}
    Let $f(x)=\dfrac{1}{x}$. Find the equation of the tangent line at $x=1$.
  \end{ex*}
  \vspace*{\stretch{1}}
  \pagebreak
