...
\relscale{\relscalefact}
  ...
  \end{ex*}
  \begin{ex*}
    Use a truth table to show that $p \lor q \rightarrow r \equiv \parens{p\rightarrow r} \land \parens{q\rightarrow r}$
    ...
    \begin{center}
      ...
      \begin{tabular}{@{}ccc|cc|cc|c@{}}
        \hline
        $p$& $q$& $r$& $p\lor q$& $p\lor q\rightarrow r$& $p\rightarrow r$& $q\rightarrow  r$& $\parens{p\rightarrow r} \land \parens{q\rightarrow r}$\\
        \hline
        T&T&T&&&&&\\
        T&T&F&&&&&\\
        T&F&T&&&&&\\
...
%  \pagebreak
  ...
  \begin{thmBox*}[Order of Operations for Logical Operators]
    ...
    \begin{tabular}{@{}ll@{}}
      ...
      $\rightarrow, \leftrightarrow$ & Evaluate $\rightarrow$ and $\leftrightarrow$ third. When both present, parentheses may be needed.
    \end{tabular}
  \end{thmBox*}
  \pagebreak
