  ...
  \begin{center}
    \begin{tikzpicture}[
      ...
      \begin{axis}[
        ...
        xtick={-1.96,0,1.96},
        xticklabels={,$p\mathrlap{_0}$,},
        xticklabel style = {font=\LARGE},
        ytick=\empty,
        clip=false,
        width=\linewidth, height=0.95*\axisdefaultheight,
        xlabel=,
        ]
        ...
        % denote crit values
        \node[font=\LARGE] at (-1.96,-0.075) {$\mathllap{-}z\mathrlap{^*}$};
        \node[font=\LARGE] at (0,-0.075) {$0$};
        \node[font=\LARGE] at (1.96,-0.075) {$z\mathrlap{^*}$};
        % Curly braces for regions
        \draw [myBrace] (axis cs:-4,-0.1) -- (axis cs:-1.98,-0.1)
          node[braceNode] {$\abs{z}> z^*$\\$p$-value $<\alpha$ \\ Reject $H_0$};
        \draw [myBrace] (axis cs:-1.94,-0.1) -- (axis cs:1.94,-0.1)
          node[braceNode] {$\abs{z}< z^*$\\$p$-value $>\alpha$ \\ Fail to reject $H_0$};
