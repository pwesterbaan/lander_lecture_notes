 ...
 \section{2.4: Limits}
  ...
  \begin{extasks}[after-item-skip=2\baselineskip](1)
    \task on the interval $[t,2]$
      \begin{center}
        \begin{tabular}{@{}*{6}{p{0.125\linewidth}}@{}}\toprule
...
%    \task
  ...
  \begin{extasks}[after-item-skip=\stretch{1}](1)
    ...
    \task $\displaystyle \lim_{x\to \pm\infty} \dfrac{3x^5+2x^3-4}{7x^4+4x^2-1}$
  \end{extasks}
  \vspace*{\stretch{1}}
  \pagebreak

  % \smash{\raisebox{-\height}{\href{https://www.desmos.com/calculator/izlmkakqnp}{\textcolor{blue}{\underline{Graph}}}}}
  \begin{center}
