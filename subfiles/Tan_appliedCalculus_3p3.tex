...
\relscale{\relscalefact}
  ...
  \begin{thmBox*}[Rule 7: The Chain Rule]
    \begin{align*}
      % \ddx\sbrkt{f\parens{g(x)\vphantom{^1}}}&=f'\parens{g(x)}g'(x)
      \ddx\sbrkt{\coloredParens{black}{f}{\big}{
        \coloredParens{lander_blue}{g}{}{x}}}
      &=\coloredParens{black}{f'}{\big}{
          \coloredParens{lander_blue}{g}{}{x}}\cdot
        \coloredParens{lander_blue}{g'}{}{x}
    \end{align*}
  ...
  \begin{thmBox*}[The General Power Rule]
    \begin{align*}
      \ddx\sbrkt{\parens{f(x)}^n}&=n\parens{f(x)}^{n-1} f'(x)
    \end{align*}
  \end{thmBox*}
  \begin{ex*}
