...
\relscale{\relscalefact}
  ...
  \begin{ex*}
    Find the expression for the average rate of change of $j(t)=\dfrac{1}{t+3}$ on the interval $\sbrkt{1,1+h}$.
  \end{ex*}
  \vspace*{\stretch{1}}
  ...
  \begin{ex*}
    Find the expression for the average rate of change of $g(x)=\sqrt{x-1}$ on the interval $\sbrkt{x,x+h}$.
  \end{ex*}
  \vspace*{\stretch{1}}
    ...
    \begin{flushright}
      ...
      \begin{tikzpicture}[declare function={
        ...
        \begin{axis}[
          ...
          \addplot[-] expression[domain=-2.5:3]{f(x)};
          \addplot[soldot] coordinates{(-2.5,{f(-2.5)})(3,{f(3)})};
        \end{axis}
      \end{tikzpicture}
      }}
    \end{flushright}
