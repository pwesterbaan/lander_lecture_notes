  ...
  \begin{ex*}
    ...
    \begin{center}
      ...
      \begin{tikzpicture}[
        ...
        \draw (v_1) -- (v_2) node[edgeLbl, above right] {$e_1$};
        \draw (v_2) -- (v_3) node[edgeLbl, below left] {$e_3$};
        \draw (v_3) -- (v_4) node[edgeLbl, above] {$e_5$};
        \draw (v_4) -- (v_5) node[edgeLbl, below right] {$e_2$};
        \draw (v_5) -- (v_1) node[edgeLbl, above left] {$e_4$};
      \end{tikzpicture}
    \end{center}
    \vspace*{\stretch{1}}
  \end{ex*}
    ...
    \begin{minipage}{0.45\linewidth}
      \begin{center}
        \begin{tikzpicture}[
          ...
          \node[label=90:$w_1$] (w1) {};
          \node[right=of w1, label=90:$w_1$] (w3) {};
    ...
    \begin{minipage}{0.45\linewidth}
      \begin{center}
        \begin{tikzpicture}[
          ...
          %%
          \draw (v1) -- (v2) -- (v3) -- (v4) -- (v1) -- (v5) -- (v3) (v1) -- (v6) -- (v2);
        \end{tikzpicture}
      \end{center}
    \end{minipage}
    \hspace*{\stretch{1}}
