...
%  \pagebreak
  ...
  \begin{ex*}
    Use the extended Euclidean algorithm to express $\gcd(330,156)$ as a linear combination of $330$ and $156$.
    \vspace*{\stretch{1}}
  \end{ex*}
  \pagebreak
...
%%  \textbf{RSA Crypotography}
  \begin{defn*}[RSA Cryptography]
    ...
    \end{itemize}
    The security of RSA encryption relies on the difficult in factoring very large numbers.
  \end{defn*}
  \pagebreak
