...
\relscale{\relscalefact}
  ...
  \begin{center}
    ...
    \begin{tabular}{P{0.42\linewidth}m{0.2\linewidth/3}m{0.42\linewidth}}
      \underline{Implicit Functions} & & \underline{Explicit Functions} \hfill \href{https://www.desmos.com/calculator/gxlimjndt8}{\textcolor{blue}{\underline{Graph}}}\\
      $x^2y+y-x^2+1=0$&  & $y=\dfrac{x^2-1}{x^2+1}$\\
      $x^2+y^2=4$ & & $y=\pm\sqrt{4-x^2}$\\
