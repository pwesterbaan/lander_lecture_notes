...
%  \relscale{1.4} %TODO
  ...
  \begin{tabularx}{\linewidth}{
    ...
    >{\hsize=0.50\hsize}X
    >{\hsize=1.25\hsize}X}
    \underline{Implicit Functions} & & \underline{Explicit Functions} \hfill \href[pdfnewwindow]{https://www.desmos.com/calculator/gxlimjndt8}{\textcolor{blue}{\underline{Graph}}}\\[\baselineskip]
  ...
  \end{ex*}
  \begin{flushright}
    \begin{tikzpicture}[scale=1.4] %%Used to match text scaling
