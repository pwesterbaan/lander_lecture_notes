...
%\relscale{1.4} %TODO
    ...
    \fbox{\parbox{0.9875\linewidth}{
      \begin{description}
        ...
        \item[Addition Property:] The equation formed by adding the same quantity to both sides of an equation is equivalent to the original equation:
          \begin{align*}
            x-4&=6 & x+5&=12\\
            x-4\textcolor{red}{+4}&=6\textcolor{red}{+4}& x+5\textcolor{lander_blue}{+(-5)}&=12\textcolor{lander_blue}{+(-5)}\\
            x&=10& x&=7
          \end{align*}
    ...
    \fbox{\parbox{0.9875\linewidth}{
      \begin{description}
        ...
        \item[Addition Property:] The inequality formed by adding the same quantity to both sides of an inequality is equivalent to the original inequality:
          \begin{align*}
            x-4&<6 & x+5&\geq12\\
            x-4\textcolor{red}{+4}&<6\textcolor{red}{+4}& x+5\textcolor{lander_blue}{+(-5)}&\geq 12\textcolor{lander_blue}{+(-5)}\\
            x&<10& x&\geq 7
          \end{align*}
        \item[Multiplication Property] The inequality formed by multiplying both sides of an inequality by the same \emph{positive} quantity is equivalent to the original inequality. The direction of the inequality is flipped when multiplying by a \emph{negative} quantity:
          \begin{align*}
            \frac{1}{3}x&>6 & 5x-5&\leq6x+20\\
            3\parens{\frac{1}{3}x}&>3(6) & -x&\leq 25\\
            x&>18& x&\geq-25
          \end{align*}
      \end{description}
    }}
  ...
  \begin{ex*}
    Solve
      \[-x+8\leq 2x-4\]
    first by gathering the $x$ variable on the left, then again on the right. See that the multiplication property holds in both cases.
    \begin{flushright}
      \begin{tikzpicture}[scale=1.0, declare function={
        f(\x)=-x+8;
        g(\x)=2*x-4;}]
