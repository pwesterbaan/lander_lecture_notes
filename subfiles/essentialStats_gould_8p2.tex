...
%  \relscale{1.4} %TODO
  ...
  \fbox{\parbox{0.9875\linewidth}{
    \begin{enumerate}
      ...
      \item \textbf{Check conditions:} similar the CLT, we require
        \begin{itemize}
          \item \textbf{Random Sample:} The sample must be randomly collected from the population.
          \item \textbf{Large Sample:} The sample size must be large enough for at least 10 successes, $np\geq 10$, and 10 failures, $n(1-p)\geq 10$.
      ...
      \item \textbf{Interpret:} Decided whether to reject or fail to reject the null hypothesis.
    \end{enumerate}
  }}
  \pagebreak
