...
\relscale{\relscalefact}
  ...
  \begin{ex*}
      ...
      \begin{minipage}{0.4\linewidth}
        \begin{center}
          ...
          \begin{tikzpicture}[
            ...
            \draw (2,0) circle [x radius=1.25, y radius=1.9];
            \node at (2,2.5) {$Y$};
            \node[myPoint, label=180:$2$] (2) at (-1.85,0) {};
            \node[myPoint, above=of 2, label=180:$1$] (1){};
            \node[myPoint, below=of 2, label=180:$3$] (3) {};
            %
            \node[myPoint, label=0:$b$] (b) at (1.85,0) {};
            \node[myPoint, above=of b, label=0:$a$] (a) {};
            \node[myPoint, below=of b, label=0:$c$] (c) {};
            \draw[myArrow] (1) to [bend left=10] (a);
            \draw[myArrow] (2) to [bend left=10] (b);
            \draw[myArrow] (3) to [bend right=12.5] (b);
            \node (f) at (0,2.3) {$f$};
    ...
    \begin{extasks}[after-item-skip=\stretch{1}](3)
      ...
      \task $f(2)$
      \task $f(3)$
      \task* Is $2$ an inverse image of $b$? Is $2$ an inverse image of $c$?
      \task* Find the inverse image of $a$, $b$, and $c$
