...
%  \relscale{1.4} %TODO
  \section{8.3: Hypothesis Tests in Detail}
    ...
    \begin{center}
      \href[pdfnewwindow]{https://www.reddit.com/r/Mcat/comments/ao6ovi/type_i_and_type_ii_errors/}{\includegraphics[width=0.85\linewidth]{images/Type_I_and_II_error.jpg}}
      \vspace*{\stretch{1}}
