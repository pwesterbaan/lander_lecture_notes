...
%  \relscale{1.4} %TODO
  \section{4.2: Measuring Strength of Association with Correlation}
    ...
    \begin{center}
      ...
      Take a few minutes to look at the graphs at this link: \href[pdfnewwindow]{https://www.tylervigen.com/spurious-correlations}{\textcolor{blue}{\underline{Spurious correlations}}}\\[\baselineskip]

      \href[pdfnewwindow]{https://xkcd.com/552}{\includegraphics[width=0.85\linewidth]{images/correlation_2x_xkcd_552}}
    \end{center}
    \pagebreak
    ...
    \begin{center}
      \begin{tikzpicture}[nodes=black]
        \begin{groupplot}[
          ...
          width=0.45\linewidth, height=0.8*\axisdefaultheight, %height=0.3\linewidth,
...
%          ymin=-4.25, ymax=4.25,
          ...
          width=0.55\linewidth, height=0.8*\axisdefaultheight, %height=0.3\linewidth,
          ticklabel style={font=\footnotesize,inner sep=0.5pt,fill=white,opacity=1.0, text opacity=1},
          xlabel=Age (years), xlabel style={at={(ticklabel* cs:0.5)},anchor=north, yshift=-10pt},
          ylabel=Time (hours), ylabel style={at={(ticklabel* cs:0.5)},anchor=south, xshift=-20pt, rotate=90},
          clip=false,
          ]
            \addplot[only marks, blue] table [x=x_sim, y=y_sim, col sep=comma] {\subfiles/scat_plot_data_4p2.csv} node at (62.5,3.75) {$r=0$};
        \end{axis}
      \end{tikzpicture}
      \vspace*{\stretch{1}}
