...
\relscale{\relscalefact}
  ...
  \begin{extasks}[after-item-skip=\stretch{1}](1)
    \task $f(x)=x^3-3x^2-24x+32$ \hfill \href{https://www.desmos.com/calculator/re1imdb5c4}{\textcolor{blue}{\underline{Graph}}}
    \task $g(x)=(x+1)^{2/3}$
  \end{extasks}
  \vspace*{\stretch{1}}
  \pagebreak
  ...
  \end{ex*}
  \begin{extasks}[after-item-skip=\stretch{1}](1)
    \task $f(x)=\parens{x-1}^{5/3}$ \hfill \href{https://www.desmos.com/calculator/1jpmsat84m}{\textcolor{blue}{\underline{Graph}}}
  \end{extasks}
  \vspace*{\stretch{1}}
  \pagebreak
  ...
  \begin{ex*}
    Find the relative extrema of
      \[f(x)=x^3-3x^2-24x+32\]
      \hfill \href{https://www.desmos.com/calculator/re1imdb5c4}{\textcolor{blue}{\underline{Graph}}}
  \end{ex*}
  \pagebreak
    ...
    \begin{tikzpicture}[declare function={
      ...
      \begin{axis}[
        ...
        clip=false
          ...
          \node[custNode, above left] at (a,ga) {Absolute\\min};
  ...
  \begin{center}
    \begin{tabular}{@{}*{2}{p{0.315\linewidth}}l@{}}\toprule
      $f(x)$& $f'(x)$& $f''(x)$\\\midrule
      increasing& positive& ---\\
      decreasing& negative& ---\\
