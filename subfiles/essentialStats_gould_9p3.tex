...
%    The graph below shows the $t$-distribution in black where the degrees of freedom are $1$, $2$, $4$, and $30$, and the Standard Normal Distribution in blue.
    ...
    \begin{center}
      \begin{tikzpicture}[scale=1.0, declare function={
        ...
        \begin{axis}[
          cycle list={lander_blue,blue,green!50!black,purple!80!black,red!50!orange},
          line legend,
...
%          ymin=ymin, ymax={1.1*gauss(mu,mu,sig)},
          ...
          dfNode/.style={inner sep=0pt, fill=white, opacity=0.15, text opacity=1.0}
          clip=false,
          ]
          ...
          \pgfplotsinvokeforeach {25,4,2,1}{
            \def\n{#1} %explicitly define \n for gnuplots
            \addplot gnuplot [thick,smooth, no marks, line width=1pt]{\students};
