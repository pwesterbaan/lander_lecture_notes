...
\relscale{\relscalefact}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=0.8, declare function={
      ...
      \begin{groupplot}[
        ...
        group style={group size=3 by 1, horizontal sep=30mm},
        axis lines=center,
        ...
        xlabel=$x$, xlabel style={at={(ticklabel* cs:1)},anchor=south west, xshift=5pt},
  ...
  \begin{ex*}
    ...
    \begin{tasks}[after-item-skip=\stretch{1}, label=\textbullet](1)
      ...
      \task Find the \textbf{break-even point} (where $R(x)=C(x)$ and $P(x)=0$). What happens if we sell more or less than the break-even point?
    \end{tasks}
  \end{ex*}
  \vspace{\stretch{0.5}}
